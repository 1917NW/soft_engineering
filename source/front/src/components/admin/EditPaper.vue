<template>
  ...
  <el-form ref="form" :model="paperModel" label-width="80px" style="margin-top: 10px;">
    ...
    <el-form-item> <el-button type="success" size="mini" class="question-item-remove" icon="el-icon-plus" @click="submitPaper()" >修改试卷</el-button> </el-form-item>
  </el-form>
...
export default {
    ...
    methods:{
        ...
        submitPaper(){
            paperApi.updatePaper(this.paperModel).then(res => {
                this.$message({
                message : res.message,
                type : 'success'
              });
