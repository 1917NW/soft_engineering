...
<el-descriptions title="试卷信息" >
    <el-descriptions-item label="试卷ID">{{ selectedPaper.paperId }}</el-descriptions-item>
    <el-descriptions-item label="试卷名称">{{ selectedPaper.paperName }}</el-descriptions-item>
</el-descriptions>
